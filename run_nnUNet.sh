...
#PBS -N nnUNet_TotalSegmentator_set3
...
nnUNetv2_plan_and_preprocess -d 303 -c 3d_fullres -np 3 --verify_dataset_integrity

# Train
nnUNetv2_train 303 3d_fullres all